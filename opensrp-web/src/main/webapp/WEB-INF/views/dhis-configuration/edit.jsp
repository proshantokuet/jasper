				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Edit DHIS2 configuration
							</div>
						</div>
								...
								<div class="form-group">
					              <div class="row">
					                <div class="col-lg-6 form-group"> 
										...
										<input name="formName" id="formName" value="${dhisConfiguration.getFormName() }" class="form-control" required="required" />
					                 </div>
					                 <div class="col-lg-6 form-group">
					                   <label class="control-label" for="code"> Field name <span class="required">* </span></label>
									   <input name="fieldName" value="${dhisConfiguration.getFieldName() }" class="form-control"  id="fieldName"  required="required" type="text">  
					            ...
					            <div class="form-group">
					              <div class="row">
					                <div class="col-lg-6 form-group"> 
										...
										<input name="dhisId" id="dhisId" value="${dhisConfiguration.getDhisId() }" class="form-control" required="required" />
					                 </div>
					                  <div class="col-lg-6 form-group"> 
						                <label class="control-label" for="name"> Value 	</label>
										<input name="value" id="value" class="form-control" value="${dhisConfiguration.getValue() }" />
					                 </div>
					            ...
					            <div class="form-group">
					              <div class="row">
					                 ...
					                 <div class="col-lg-6 form-group"> 
										...
										<c:choose>
										<c:when test="${dhisConfiguration.getStatus()}">
											<input type="checkbox" checked class="checkBoxClass form-check-input"
					                 ...
					                 <div class="col-lg-6 form-group"> 
										...
										<c:choose>
										<c:when test="${dhisConfiguration.getDynamic()}">
											<input type="checkbox" checked class="checkBoxClass form-check-input"
