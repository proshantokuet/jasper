...
<%@page import="org.opensrp.core.entity.Permission"%>
 <title><spring:message code="lbl.addUpazila"/></title>
...
<c:url var="listUrl" value="/location/upazila-list.html" />
...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="<c:url value="/location//upazila-list.html"/>">
					Back</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i> <spring:message code="lbl.addUpazila"/>
							</div>
								...
								<div class="form-group">
					              <div class="row">
					                <div class="col-lg-6 form-group"> 
						                <label class="control-label" for="name"> <spring:message code="lbl.upazilaName"/> <span class="required">* </span>	</label>
										<input id="name" class="form-control" name="name" required="required"/>
					                 </div>
					                  <div class="col-lg-6 form-group">
					                   <label class="control-label" for="code"><spring:message code="lbl.upazilaCode"/> <span class="required">* </span></label>
										<input maxlength="2" id="code" class="form-control" name="code" required="required"/>
					                  </div>
 ...
 <script>
    ...
    $('#locationInfo').submit(function(event) {
        ...
        let formData = {
            ...
            'parent_location_id': $('#district-option').val(),
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                if(data == ""){
                    window.location.replace("/opensrp-dashboard/location/upazila-list.html");
                } else {
