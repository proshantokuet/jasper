...
<c:url var="list_url" value="/rest/api/v1/location/district-list" />
...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<% if(AuthenticationManagerUtil.isPermitted("ADD_DISTRICT")){ %>
										
					<a  class="btn btn-default right-text" id="add" href="<c:url value="/location/add-district.html?lang=${locale}"/>">Add new district</a> 	
					<%} %>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list"></i><spring:message code="lbl.districtList"/>
							</div>
