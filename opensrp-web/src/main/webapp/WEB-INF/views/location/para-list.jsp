...
<%@page import="org.opensrp.core.service.UserService"%>
  ...
  <title><spring:message code="lbl.villageList"/></title>
<jsp:include page="/WEB-INF/views/header.jsp" />
<jsp:include page="/WEB-INF/views/dataTablecss.jsp" />
<c:url var="list_url" value="/rest/api/v1/location/para-list" />
...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<% if(AuthenticationManagerUtil.isPermitted("ADD_PARA")){ %>
									
					<a class="btn btn-default" id="add" href="<c:url value="/location/add-para.html?lang=${locale}"/>">
					<spring:message code="lbl.addNew"/>&nbsp;<spring:message code="lbl.village"/></a>
					<%} %>
				</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list"></i>  <spring:message code="lbl.villageList"/>
							</div>
