...
<%@page import="org.opensrp.core.service.UserService"%>
 ...
 <title><spring:message code="lbl.upazilaList"/></title>
<jsp:include page="/WEB-INF/views/header.jsp" />
<jsp:include page="/WEB-INF/views/dataTablecss.jsp" />
<c:url var="list_url" value="/rest/api/v1/location/upazila-list" />
...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<% if(AuthenticationManagerUtil.isPermitted("ADD_UPAZILA")){ %>
										
					<a class="btn btn-default" id="add" href="<c:url value="/location/add-upazila.html?lang=${locale}"/>"><spring:message code="lbl.addNew"/>&nbsp;<spring:message code="lbl.upazila"/></a> 
					<%} %>
					</li>
			</ul>
			<!-- END PAGE BREADCRUMB -->
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list"></i><spring:message code="lbl.upazilaList"/>
							</div>
...
<script>
    ...
    $(document).ready(function() {
        locations = $('#locationListWithPagination').DataTable({
            ...
            destroy: true,
            language: {
                searchPlaceholder: "Upazila Name"
            }
        });
    });
</script>
