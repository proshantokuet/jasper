...
<%
	...
	boolean topic = AuthenticationManagerUtil.isPermitted("TOPIC");
%>
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu">
					...
					<% if(PERM_UPLOAD_LOCATION){ %>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<c:url value="/location/district-list.html?lang=${locale}"/>">
						<strong><spring:message code="lbl.districtList"/></strong></a>
					<% } %>
					<% if(PERM_UPLOAD_LOCATION){ %>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<c:url value="/location/upazila-list.html?lang=${locale}"/>">
						<strong><spring:message code="lbl.upazilaList"/></strong></a>
					<% } %>
					<% if(PERM_UPLOAD_LOCATION){ %>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<c:url value="/location/pourasabha-list.html?lang=${locale}"/>">
						<strong><spring:message code="lbl.pourasabhaList"/></strong></a>
					<% } %>
					<% if(PERM_UPLOAD_LOCATION){ %>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<c:url value="/location/union-list.html?lang=${locale}"/>">
						<strong><spring:message code="lbl.unionList"/></strong></a>
					<% } %>
					<% if(PERM_UPLOAD_LOCATION){ %>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<c:url value="/location/para-list.html?lang=${locale}"/>">
						<strong><spring:message code="lbl.villageList"/></strong></a>
					<% } %>
					<% if(PERM_UPLOAD_LOCATION){ %>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<c:url value="/location/para-center-list.html?lang=${locale}"/>">
						<strong><spring:message code="lbl.paraCenterList"/></strong></a>
					<% } %>
					<% if(PERM_UPLOAD_LOCATION){ %>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<c:url value="/location/cluster-list.html?lang=${locale}"/>">
						<strong><spring:message code="lbl.clusterList"/></strong></a>
					<% } %>
				</div></li>
			<% } %>
