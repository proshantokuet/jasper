				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Add general meeting minutes
							</div>
					              ...
					              <div class="row">
					                  ...
					                  <input name="type"  id="type" value="OMM" type="hidden">
					                   ...
					                   <div class="col-lg-6 form-group"> 
										...
										<input name="totalParticipants" required="required" id="totalParticipants" type="number" min="1" class="form-control">  
