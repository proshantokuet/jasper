...
<c:url var="export_url" value="/other-meeting-minutes/${meeting.id}/OMM/export.html" />
<c:url var="download_url" value="/other-meeting-minutes/${meeting.id}/OMM/downlaod.html" />
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-madison">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-view"></i>General meeting minutes details
							</div>
						</div>
								...
								<div class="form-group">
					              <div class="row">
					                <div class="col-lg-12 form-group"> 
						                <label class="control-label" for="name"><strong> Meeting Type:</strong> </label>
										${meeting.getMeetingOrWorkPlane() }
					                 </div>
					                  <div class="col-lg-12 form-group">
					                   <label class="control-label" for="code"> <strong>Meeting Date:</strong> </label>
